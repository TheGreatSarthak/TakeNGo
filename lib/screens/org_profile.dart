          ...
          children: [
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                hintText: 'Enter name of your organisation',
            ...
            TextField(
              ...
              textAlign: TextAlign.center,
              decoration: const InputDecoration(
                hintText: 'Enter email id of your organisation',
                border: OutlineInputBorder(
                  borderRadius: BorderRadius.all(
                    Radius.circular(5),
                  ),
            ...
            TextField(
              ...
              textAlign: TextAlign.center,
              decoration: const InputDecoration(
                hintText: 'Enter contact number of your organisation',
                border: OutlineInputBorder(
                  borderRadius: BorderRadius.all(
                    Radius.circular(5),
                  ),
